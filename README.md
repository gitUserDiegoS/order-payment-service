...
1. Execute scripts database located in api user service https://github.com/gitUserDiegoS/ecommerce-user-service<br> 
...
2. Environment Variables<br> 
    ...
    2.2. Set the following environment variables:<br> 
   ```json
